  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${API_URL}/auth/login`, {
        ...
        // CRÍTICO: 'credentials: include' é obrigatório para Cookies HttpOnly
        credentials: 'include',
      ...
      // Persistência de UI: Dados não-críticos para o Header
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                // pr-10 garante que o texto não fique embaixo do ícone
                className="w-full p-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 
                dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:focus:ring-blue-400 transition-colors pr-10"
                onChange={handleChange}
              />
              <button
                type="button"
